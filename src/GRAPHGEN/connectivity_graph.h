...
graph MakeAdjacencies(const pixel_set &ps,
                      const Connectivity conn = Connectivity::EIGHT);
...
std::vector<std::string> GenerateAllPossibleLabelingActions(
    const graph &ag, const Connectivity conn = Connectivity::EIGHT);
